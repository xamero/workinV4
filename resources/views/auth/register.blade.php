...
<div class="container">
    <div class="row  vh-100">
        <div class="col-md-12 position-relative">
            <div class="card position-absolute top-50 start-50 translate-middle border-0 shadow w-100 bg-pilipinas" style="max-width: 25rem">
                ...
                <div class="card-body px-md-5 pb-md-5 ">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <a class="btn btn-outline-primary form-control text-white" href="{{route('googleLogin')}}">
