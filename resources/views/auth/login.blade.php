...
<head>
    ...
    <meta property="og:description" content="@yield('meta_description', 'Official website of Ilocos Norte, Philippines. Get news, updates on events, downloads, photos, videos and livestreams.')" />
    <meta property="og:image" content="@yield('meta_image', asset('images/background/cap.jpg'))" />
    ...
    <div class="container">
        <div class="row  vh-100">
            <div class="col-md-12 position-relative">
                <div class="card position-absolute top-50 start-50 translate-middle border-0 shadow w-100 bg-pilipinas"
                    style="max-width: 25rem">
                    <img src="{{ asset('lam-ang/images/logo.png') }}" class="card-img-top mx-auto position-relative"
                        alt="..." style="max-width: 150px; top: -50px">
                    <div class="card-body px-md-5 pb-md-5">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class=" mt-4">
                                ...
                                <x-button class="btn btn-primary form-control mt-2">
                                    {{ __('Log in') }}
                                </x-button>
                                <p class="text-center mb-0">or</p>
                                <a class="btn btn-outline-primary text-white form-control" href="{{ route('googleLogin') }}">
