...
class Index extends Component
{
    ...
    public $title, $details, $sub_specialization_id, $job_type, $location, $salary_from, $salary_to,
        $total_vacancy, $is_public, $applicant_counter, $status = '';
    ...
    {
        return view('livewire.employer.vacancy.index')
            ->layout('components.layouts.portal', ['header'=> 'Manage Job Vacancies', 'subheader' => 'Add, update, view and delete posted job vacancies.']);
    }
}
